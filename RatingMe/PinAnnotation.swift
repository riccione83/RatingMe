...
class PinAnnotation: NSObject, MKAnnotation {
    ...
    init(coordinate: CLLocationCoordinate2D, title:String, subtitle: String, tag: NSNumber, rating:String, link:String, ID:String, Q1:String, Q2:String, Q3:String, isAdv:String, advImgLink:String) {
